...
fn main() {
    ...
    let geometries : Vec<Box< <ClassicRaytracer<f64, RGB<f64>> as Raytracer>::RenderableTraitType>> = vec![plane_geometry, aab_geometry, sphere_geometry, triangle_geometry];
